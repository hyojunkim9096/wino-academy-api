// ============================================================================
// src/main/java/com/wino/academyapi/domain/subject/controller/admin/AdminSubjectController.java
// ----------------------------------------------------------------------------
// 관리자 과목 관리 컨트롤러
...
package com.wino.academyapi.domain.subject.controller.admin;
