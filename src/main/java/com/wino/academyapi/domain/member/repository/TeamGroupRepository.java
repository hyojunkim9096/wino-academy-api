// src/main/java/com/wino/academyapi/domain/member/repository/TeamGroupRepository.java
package com.wino.academyapi.domain.member.repository;

import com.wino.academyapi.domain.member.dto.TeamDtos.TeamSummaryRes;
import com.wino.academyapi.domain.member.entity.TeamGroup;
...
public interface TeamGroupRepository extends JpaRepository<TeamGroup, Long>, JpaSpecificationExecutor<TeamGroup> {
    ...
    // 사용하려면 '.' 대신 '$'를 사용해야 합니다.
    //
    // (변경 전) ...new com.wino.academyapi.domain.member.dto.TeamDtos.TeamSummaryRes(
    // (변경 후) ...new com.wino.academyapi.domain.member.dto.TeamDtos$TeamSummaryRes(
    // ========================================================================
    @Query(
            value = """
            select new com.wino.academyapi.domain.member.dto.TeamDtos$TeamSummaryRes(
                 tg.id,
                 tg.teamCode,
                 tg.teamName,
                 tg.description,
