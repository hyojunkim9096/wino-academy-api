// src/main/java/com/wino/academyapi/domain/classs/service/ClassOpsService.java
package com.wino.academyapi.domain.classs.service;

import com.wino.academyapi.domain.classs.dto.ClassOpsDtos;
...
public class ClassOpsService {
    ...
    // PREVIEW
    // ────────────────────────────────────────────────────────────────
    public ClassOpsDtos.PreviewRes preview(String work, String stage, Long semId){
        ...
        return new ClassOpsDtos.PreviewRes(classCnt, subjectCnt, slotCnt, lastSnapshotAt);
    }
    ...
    // ────────────────────────────────────────────────────────────────
    @Transactional
    public ClassOpsDtos.SimpleAck snapshotAndClose(Long appUserId, ClassOpsDtos.CloseReq req){
        ...
        return new ClassOpsDtos.SimpleAck("snapshot+close done",
    ...
    // ────────────────────────────────────────────────────────────────
    @Transactional
    public ClassOpsDtos.SimpleAck restoreFromSnapshot(Long appUserId, ClassOpsDtos.RestoreReq req){
        ...
        return new ClassOpsDtos.SimpleAck("restore done", affectedC, affectedS, affectedTDel + affectedTIns);
    }
