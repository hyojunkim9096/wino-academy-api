// src/main/java/com/wino/academyapi/domain/securityrule/controller/admin/AdminSecurityRuleController.java
package com.wino.academyapi.domain.securityrule.controller.admin;
